...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_planck_grid(
      ...
      CPSWORD ,   KC_A  , MT_LRNG , MT_LMID , MT_LIDX ,   KC_G  ,   KC_K  , MT_RIDX , MT_RMID , MT_RRNG ,   KC_O  , NUMWORD ,
       KC_NO  ,   KC_Z  ,   KC_X  ,   KC_C  ,   KC_D  ,   KC_V  ,   KC_M  ,   KC_H  , CT(DOT) , CT(LPRN), KC_SLSH ,  KC_NO  ,
       KC_NO  ,  KC_NO  ,  KC_NO  , RSYMMOD , NAV_SPC , KC_BSPC , WRK_ENT ,   KC_E  , LSYMMOD ,  KC_NO  ,  KC_NO  ,  KC_NO
  ),
  [NUM] = LAYOUT_planck_grid(
      ...
      _______ , _______ , _______ , _______ , _______ , _______ , _______ ,  L_BASE ,  KC_NO  , _______ , _______ , _______
  ),
  [RSYM] = LAYOUT_planck_grid(
      ...
      _______ , _______ , _______ ,  KC_NO  , _______ , _______ , _______ ,  L_BASE ,  L_FUN  , _______ , _______ , _______
  ),
  [LSYM] = LAYOUT_planck_grid(
      ...
      _______ , _______ , _______ ,  L_FUN  , _______ , _______ , _______ ,  L_BASE ,  KC_NO  , _______ , _______ , _______
  ),
  [WRKS] = LAYOUT_planck_grid(
